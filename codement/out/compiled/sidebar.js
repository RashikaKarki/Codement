    ...
    ***************************************************************************** */
    ...
    function create_else_block(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<h2 style="margin-bottom: 1rem">Share Code</h2>`;
    		},
    		m(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (!/*session*/ ctx[0]) return create_if_block;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*session, client*/ 3) {
    			{
    				if (session) {
    					$$invalidate(1, client = new ApolloClient({
    	...
    	return [session, client, click_handler];
    }
